    ...
    <body>
        <nav class="navbar bg-transparent">
            <div class="container d-flex">
                <a class="navbar-brand p-2 flex-grow-1" href="pages/home/home.php">
                    <img src="assets/images/owl-blue.png" alt="Logo" width="40" height="40"
                        class="d-inline-block align-text-top">
                    Hello,
                    <?php echo $_SESSION['user_name']; ?>!
                </a>

                <a href="auth/logout.php" class="nav-item fs-5">
                    <img src="assets/images/logout.png" alt="logout" width="35" height="40"
        ...
        if (isset($_POST['update_book'])) {
            ...
            if (!$result) {
                ...
                header("Location: pages/home/home.php?update_msg=You have updated the data successfully");
            }

        } ?>

        <form action="pages/update/update.php?id_new=<?php echo $id ?>" method="post">
